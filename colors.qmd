...
The highlighting is implemented using [skylighting](https://github.com/jgm/skylighting) which uses the following abbriviations for each type of code element.
...
and changing the font sizes are not adviced as it will mess with the alignment too much.
