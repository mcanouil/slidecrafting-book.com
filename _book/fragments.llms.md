...
## 11.1 Highlight incremental lists
...
And we are willing to tap into some scss we can condense it down quite a lot using [SCSS loops](scss.llms.md#using-each-to-automatically-create-classes).
