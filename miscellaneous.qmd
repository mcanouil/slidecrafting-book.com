---
title: Miscellaneous
description: "Miscellaneous Quarto reveal.js tips: hiding slides with visibility=hidden, avoiding duplication with includes, and other tricks that don't fit elsewhere."
---
...
![
  ...
  examples/miscellaneous/tip-3.html
){
  .slide-deck
  loading="lazy"
  width="560"
  height="373"
  title="Demo of hidden slides using visibility=hidden"
}

[{{< fa file >}}qmd](examples/miscellaneous/tip-3.qmd){.listing-slides .btn-links target="_blank"}
