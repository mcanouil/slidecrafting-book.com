...
![
  ...
  examples/colors/colors.html
){
  .slide-deck
  loading="lazy"
  width="560"
  height="373"
  title="Slides with custom color palette via Sass variables"
}
...
![
  ...
  examples/colors/colors-headers.html
){
  .slide-deck
  loading="lazy"
  width="560"
  height="373"
  title="Slides with heading color set via lighten() Sass function"
}
...
![
  ...
  examples/colors/no-syntax-highlighting.html
){
  .slide-deck
  loading="lazy"
  width="560"
  height="373"
  title="Code slides without custom syntax highlighting"
}

[{{< fa file >}}qmd](examples/colors/no-syntax-highlighting.qmd){.listing-slides .btn-links target="_blank"}
[{{< fa brands sass >}}scss](examples/colors/no-syntax-highlighting.scss){.listing-video .btn-links target="_blank"}
...
![
  ...
  examples/colors/syntax-highlighting.html
){
  .slide-deck
  loading="lazy"
  width="560"
  height="373"
  title="Code slides with custom CSS syntax highlighting"
}

[{{< fa file >}}qmd](examples/colors/syntax-highlighting.qmd){.listing-slides .btn-links target="_blank"}
[{{< fa brands sass >}}scss](examples/colors/syntax-highlighting.scss){.listing-video .btn-links target="_blank"}
