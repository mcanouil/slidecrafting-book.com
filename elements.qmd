...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Custom hamburger menu icon via CSS background-image" src="examples/styling/tip-2.html">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Displaying Quarto code as unexecuted source using double curly brackets" src="examples/elements/tip-6.html">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Plot with auto-stretch enabled (default)" src="examples/elements/plot-sizing-examples.html#/auto-stretch">
Plot slide with `auto-stretch: true` (default): the figure is automatically scaled down to fit within the slide boundaries.
</iframe>

<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Plot with .nostretch class (natural size)" src="examples/elements/plot-sizing-examples.html#/no-auto-stretch">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Plot and title with auto-stretch enabled" src="examples/elements/plot-sizing-examples.html#/auto-stretch-1">
Plot and title text on the same slide with `auto-stretch` enabled: image is shrunk to fit alongside the other content.
</iframe>

<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Plot and title with .nostretch class" src="examples/elements/plot-sizing-examples.html#/no-auto-stretch-1">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Plot with out-width: 6in, out-height: 3.5in" src="examples/elements/plot-sizing-examples.html#/section">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Comparison of small out-width/out-height with default-sized chart" src="examples/elements/plot-sizing-examples.html#/section-1">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Chart with fig-width: 9, fig-height: 5 (Reveal.js defaults)" src="examples/elements/plot-sizing-examples.html#/section-2">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Chart with reduced fig-width and fig-height for better readability" src="examples/elements/plot-sizing-examples.html#/section-3">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Another fig-width/fig-height comparison" src="examples/elements/plot-sizing-examples.html#/section-4">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Fourth fig-width/fig-height variant showing larger, more legible chart text" src="examples/elements/plot-sizing-examples.html#/section-5">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Square chart using equal fig-width and fig-height values" src="examples/elements/plot-sizing-examples.html#/section-6">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Chart using fig-asp to fix aspect ratio for proportional scaling" src="examples/elements/plot-sizing-examples.html#/section-7">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Same fig-asp at different fig-height showing proportional scaling" src="examples/elements/plot-sizing-examples.html#/section-8">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Chart with fig-align: left" src="examples/elements/plot-sizing-examples.html#/section-9">
Chart with `fig-align: left`: the figure is positioned against the left edge of the slide content area.
</iframe>

<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Chart with fig-align: center" src="examples/elements/plot-sizing-examples.html#/section-10">
Chart with `fig-align: center`: the figure is centered horizontally on the slide.
</iframe>

<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Chart with fig-align: right" src="examples/elements/plot-sizing-examples.html#/section-11">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Chart at standard DPI" src="examples/elements/plot-sizing-examples.html#/section-12">
Chart at standard DPI: text and elements may appear slightly soft at high display resolutions.
</iframe>

<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Chart at higher fig-dpi for crisp text and lines" src="examples/elements/plot-sizing-examples.html#/section-13">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Chart inside two-column layout with fig-asp adjusted for column width" src="examples/elements/plot-sizing-examples.html#/section-14">
