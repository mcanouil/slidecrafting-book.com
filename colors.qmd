---
title: "Colors"
description: "How to choose, apply, and customize color palettes in Quarto reveal.js slides using Sass variables, contrast checking, and custom syntax highlighting."
---
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Interactive demo of all 11 built-in Quarto Reveal.js themes" src="examples/all-themes/index.html">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Slides with custom color palette via Sass variables" src="examples/colors/colors.html">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Slides with heading color set via lighten() Sass function" src="examples/colors/colors-headers.html">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Code slides without custom syntax highlighting" src="examples/colors/no-syntax-highlighting.html">
...
<iframe class="slide-deck" loading="lazy" width="560" height="373" title="Code slides with custom CSS syntax highlighting" src="examples/colors/syntax-highlighting.html">
