...
<iframe class="slide-deck" loading="lazy" title="Slide deck with no custom styling applied" src="examples/10-minutes/10min-0.html">
...
<iframe class="slide-deck" loading="lazy" title="Slides after adding custom fonts" src="examples/10-minutes/10min-1.html">
...
<iframe class="slide-deck" loading="lazy" title="Slides after adding dark theme colors" src="examples/10-minutes/10min-2.html">
...
<iframe class="slide-deck" loading="lazy" title="Completed 10-minute theme with fonts, colors, and sizes" src="examples/10-minutes/10min-3.html">
